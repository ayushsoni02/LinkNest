  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">About LinkKeepers</h1>
        <div className="prose prose-lg max-w-none">
          <p className="text-gray-600 mb-6">
            LinkKeepers was born from a simple yet powerful observation: people discover amazing content every day across various platforms, but they often forget to revisit these valuable resources.
          </p>
          <p className="text-gray-600 mb-6">
