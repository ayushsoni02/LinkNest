...
const PlatformShowcase = () => {
  ...
  return (
    <section className=" dark:bg-gray-900 text-black dark:text-white py-20 px-4 sm:px-6 lg:px-8 bg-white/50">
      <div className=" dark:bg-gray-900 text-black dark:text-white max-w-7xl mx-auto">
        <div className=" dark:bg-gray-900 text-black dark:text-white text-center mb-16">
          ...
          <p className=" dark:bg-gray-900  dark:text-white text-lg text-gray-600 max-w-2xl mx-auto">
        ...
        <div className=" dark:bg-gray-900 text-black dark:text-white grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          {platforms.map((platform) => (
            <div key={platform.name} className=" dark:bg-gray-900 text-black dark:text-white text-center group">
              <div className=" dark:bg-gray-900 text-black dark:text-white bg-white rounded-2xl p-6 shadow-lg border border-gray-200/50 group-hover:shadow-xl transition-all duration-300 group-hover:-translate-y-2">
                <platform.icon className={`h-12 w-12 ${platform.color} mx-auto mb-4`} />
                <h3 className=" dark:bg-gray-900  dark:text-white font-semibold text-gray-900 mb-2">{platform.name}</h3>
                <p className=" dark:bg-gray-900 text-black dark:text-white text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                  {platform.count}
                </p>
